...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/barguzin/docker-practice/main)
...
git branch -M main
git remote add origin https://github.com/barguzin/docker-practice.git
